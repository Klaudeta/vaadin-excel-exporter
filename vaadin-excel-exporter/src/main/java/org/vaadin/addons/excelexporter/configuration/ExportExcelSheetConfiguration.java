...
public class ExportExcelSheetConfiguration<BEANTYPE> {
  ...
  private Function<Workbook, CellStyle> reportTitleStyleFunction = new DefaultReportTitleStyleFunction();
	...
	private Function<Workbook, CellStyle> generatedByStyleFunction = this.reportTitleStyleFunction;
	 ...
	 */
	public Function<Workbook, CellStyle> getReportTitleStyleFunction() {
	 ...
	 */
	public Function<Workbook, CellStyle> getGeneratedByStyleFunction() {
	 ...
	 */
	public void setReportTitleStyleFunction(final Function<Workbook, CellStyle> reportTitleStyleFunction) {
	 ...
	 */
	public void setGeneratedByStyleFunction(final Function<Workbook, CellStyle> generatedByStyleFunction) {
...
class DefaultReportTitleStyleFunction implements Function<Workbook, CellStyle> {

  private final CacheableValue<CellStyle> cellStyle = new CacheableValue<>();

  @Override
  public CellStyle apply(Workbook workbook) {
    return cellStyle.computeIfAbsent(() -> {
